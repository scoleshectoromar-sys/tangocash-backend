...
if __name__ == '__main__':
    ...
    if "--register" in sys.argv or "--unregister" in sys.argv:
        ...
        if '--prueba' in sys.argv:
            ...
            id_impositivo = 'CONSUMIDOR FINAL'        # cat. iva (mercado interno)
            forma_pago = 'CONTADO'
            ...
            ok = fepdf.EstablecerParametro("incoterms_ds", "DESTINO")
            ...
            iva_id = 5
            importe = 121.00
            despacho = u'NETO: 1 kg AFORO: 1 kg'
            dato_a = "$100.000"  # VDECL
            dato_b = "3 m3"
            dato_c = "1 m"
            dato_d = "2 m"
            dato_e = "3 m"
            ...
            fepdf.AgregarDetalleItem("", "", "", "Seguro", 1, 7, 
                    "10.00", "", iva_id, 2.10, "12.10", despacho, dato_a)

            fepdf.AgregarDetalleItem("", "", "", "Retiro", 1, 7, 
                    "0.00", "", iva_id, 0, "0", despacho, dato_a)

            fepdf.AgregarDetalleItem("", "", "", "Gestión Cobranza", 1, 7, 
                    "0.00", "", iva_id, 0, "0", despacho, dato_a)

            fepdf.AgregarDetalleItem("", "", "", "", 1, 7, 
                    "", "", iva_id, 0, "", despacho, dato_a)
                    
            fepdf.AgregarDetalleItem("", "", "", "", 1, 7, 
                    "", "", iva_id, 0, "", despacho, dato_a)

            ds = """Cuando se reciban bultos mal acondicionados y/o embalados insuficientemente, EMPRESA S.R.L., en adelante el Transportista, no será responsable por los daños que sufrieren durante su transporte, entrega en destino y/o retiro de depósito. Los daños generados por vicio propio de la carga, caso fortuito, derrame y/o roturas ocasionadas por manipuleo en el viaje, corren por cuenta del Cargador. El Transportista se reserva el derecho de rectificación en destino del aforo, tarifa y/o cálculo del flete por lo transportado. 2) La entrega y retiro a domicilio comprende únicamente el radio urbano de cada localidad. En el caso de no encontrarse el destinatario en el domicilio indicado por el Cargador y/o negándose el mismo a recibir la carga, ésta se remitirá al lugar de origen, corriendo por cuenta del Cargador todos los gastos ocasionados según la tarifa vigente al momento del despacho. 3) En los envíos no podrá incluirse correspondencia de orden privado, dinero, alhajas, valores al portador, documentos de crédito u otros valores. El Transportista no se hace responsable de su transporte, cuando tales objetos se incluyan en un envío y se perdiese o deteriorase total o parcialmente. 4) El mayor plazo para efectuar reclamos por la carga expira a las 24 horas de la entrega y debe contener el número de Carta de Porte. 5) No existiendo valor declarado ni seguro por cuenta del Cargador, ante la pérdida o deterioro de la mercadería, el Transportista solo responderá hasta el monto abonado en concepto de flete, prorrateándose el valor para el supuesto de ser parciales los daños. 6) En caso de robo de la carga el Cargador toma por su exclusiva cuenta el 20% de franquicia del seguro asumido por el Transportista y se obliga a brindar toda la colaboración necesaria a los fines de la liquidación. El Transporte se pacta en los términos del art. 1296 y ccts. del Código Civil y Comercial de la Nación. 7) Cuando el Transportista subcontrate actuará en calidad de mandatario del Cargador al solo efecto de la toma de cobertura de seguro por la carga a transportarse. 8) El Cargador exime al Transportista del deber de dar aviso de la llegada de la carga a destino. 9) Con la mercadería llegada a depósito, no retirada o demorada por causas ajenas al Transportista se actuará según el art. 1308 y cctes. del Código Civil y Comercial de la Nación. A partir de las 48 horas de la fecha de entrega la mercadería pagará el correspondiente derecho a estadía. 10) Los casos en que la carga sea transportada con seguro por cuenta del Cargador deberá precisarse el monto de la cobertura no pudiendo el Transportista percibir costo de este seguro. El Transportista hace saber que toda la mercadería entregada para su guarda y transporte, se toma a exclusivo riesgo del Cliente/Cargador, por lo cual el Transportista queda liberado de toda responsabilidad y/o acción de repetición que pudiera derivarse por las sumas abonadas por el Cliente y/o un tercero, con motivo de cualquier siniestro que pudiera afectar a las mercaderías. El Transportista se responsabilizará hasta el límite del importe asegurado por el Cliente, a cuyo fin, el Cliente deberá comunicarlo por medio fehaciente al Transportista. 11) El presente documento constituye título ejecutivo de acuerdo a los arts. 442 y cctes. del CPCC de la Provincia de Santa Fe. A los fines de la ejecución o cualquier eventualidad emergente de la presente, el Transportista constituye domicilio especial en Bv. Colón 2690 de la ciudad de Casilda, Provincia de Santa Fe y las partes se someten expresa y voluntariamente a la jurisdicción de los Tribunales Ordinarios con asiento en la ciudad de Casilda, Provincia de Santa Fe, renunciando a cualquier otro fuero o jurisdicción que pudiere corresponder, incluso el Federal."""

            fepdf.AgregarDetalleItem("", "", "", ds, 1, 0, 
                    "", "", iva_id, 0, "", despacho, dato_a)
            ...
            fepdf.AgregarDato("dato_adicional1", "JUAN PEREZ")
            fepdf.AgregarDato("dato_adicional2", "Pampa y la Via Nro. 175")
            fepdf.AgregarDato("dato_adicional3", "(1754) San Justo, Buenos Aires")
            fepdf.AgregarDato("dato_adicional4", "otro dato del destinatario")
            print "Prueba!"
